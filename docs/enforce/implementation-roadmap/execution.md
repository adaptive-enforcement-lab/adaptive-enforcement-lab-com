...
- **[Branch Protection](../branch-protection/branch-protection.md)** for Month 1, Week 1
- **[Status Checks](../status-checks/index.md)** for Month 1, Week 2
- **[GitHub Apps](../../secure/github-apps/index.md)** for Month 1, Week 3
- **[Pre-commit Hooks](../pre-commit-hooks/pre-commit-hooks.md)** for Month 2, Week 5
- **[Commit Signing](../commit-signing/commit-signing.md)** for Month 2, Week 6
- **[SBOM Generation](../../secure/sbom/sbom-generation.md)** for Month 2, Week 7
- **[Audit Evidence](../audit-compliance/audit-evidence.md)** for Month 1, Week 4; Month 3, Week 11
