...
See [File Distribution](../../patterns/github-actions/use-cases/file-distribution/index.md) for full pattern.
...
- **[Branch Protection](../branch-protection/branch-protection.md)** - Server-side enforcement
