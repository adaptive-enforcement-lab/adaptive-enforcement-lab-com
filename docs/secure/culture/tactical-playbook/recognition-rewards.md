...
1. **Monthly "Security Hero" award:**
   - Nominate via Slack form: `/security hero @person reason`
   - Winners announced in all-hands meeting
   - Feature in company newsletter
   - Small gift or bonus consideration

2. **Team-level recognition:**
...
3. **Celebrate zero-incident milestones:**
   - "API Gateway: 365 days zero security incidents 🎉"
   - Post in #general, update README badge
   - Public announcement on org blog

4. **Highlight champion achievements:**
...
- [Security Champions Program](champions-program.md) - How to identify and support champions
- [Scorecards & Dashboards](scorecards-dashboards.md) - Metrics that drive recognition decisions
- [Career Growth](career-growth.md) - Connecting recognition to career progression
