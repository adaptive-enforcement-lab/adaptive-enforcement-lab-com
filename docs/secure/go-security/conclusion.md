...
- **[OpenSSF Best Practices Badge](../../blog/posts/2025-12-17-openssf-badge-two-hours.md)** - Certification using these tools
- **[Test Coverage Patterns](../../build/coverage-patterns/coverage-patterns.md)** - Achieving high coverage
- **[Coverage Enforcement](../../enforce/testing-enforcement/coverage-enforcement.md)** - CI and pre-commit integration
