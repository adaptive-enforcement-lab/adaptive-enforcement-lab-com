---
title: Self-Hosted Runner Security Overview
description: >-
  Understanding the threat model for self-hosted GitHub Actions runners.
  GitHub-hosted vs self-hosted comparison and secure deployment patterns.
tags:
  - github-actions
  - security
  - runners
