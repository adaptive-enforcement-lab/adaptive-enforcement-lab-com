---
title: Action Pinning Overview
description: >-
  Why pinning GitHub Actions to SHA-256 commits matters for supply chain security.
  Attack vectors from unpinned actions and comparison of tag vs SHA pinning.
tags:
  - github-actions
  - security
  - supply-chain
