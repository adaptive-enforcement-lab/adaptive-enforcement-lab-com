...
The readability action is at [adaptive-enforcement-lab/readability](https://github.com/adaptive-enforcement-lab/readability). The full workflow pattern is documented at [Versioned Documentation](../../operator-manual/github-actions/use-cases/versioned-docs/index.md).
