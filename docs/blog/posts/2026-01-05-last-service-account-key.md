...
- [Least Privilege Pattern](../../patterns/security/secure-by-design/least-privilege.md) - RBAC and ServiceAccount patterns that minimize blast radius
- [Least Privilege IAM Roles](../../secure/cloud-native/gke-hardening/iam-configuration/least-privilege-roles.md) - Design GCP IAM bindings with minimal permissions
- [Audit Logging](../../secure/cloud-native/gke-hardening/iam-configuration/audit-logging.md) - Making every identity change traceable
