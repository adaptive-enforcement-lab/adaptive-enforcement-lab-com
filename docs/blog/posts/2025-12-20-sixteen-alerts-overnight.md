...
!!! tip "Implementation Guide"
    See [OpenSSF Scorecard Compliance](../../developer-guide/sdlc-hardening/supply-chain/scorecard-compliance.md) for job-level permission patterns, source archive signing, and exception documentation.
