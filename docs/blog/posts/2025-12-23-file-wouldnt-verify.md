...
!!! tip "Implementation Guide"
    See [SLSA Provenance Implementation](../../developer-guide/sdlc-hardening/supply-chain/slsa-provenance.md) for complete workflow code, version tag requirements, and Renovate exception documentation.
