...
!!! tip "General Pattern"
    ...
    These extensions build on the [Matrix Distribution](../../../../developer-guide/architecture-patterns/matrix-distribution/index.md) pattern. See that page for the underlying concepts.
