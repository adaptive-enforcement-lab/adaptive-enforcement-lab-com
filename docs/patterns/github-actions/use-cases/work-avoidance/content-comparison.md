...
This implements the [volatile field exclusion](../../../../patterns/efficiency/work-avoidance/techniques/volatile-field-exclusion.md) technique for GitHub Actions workflows.
...
For JSON/YAML files, see the [engineering pattern](../../../../patterns/efficiency/work-avoidance/techniques/volatile-field-exclusion.md) for jq/yq examples.

---

## Related

- [Work Avoidance Pattern](../../../../patterns/efficiency/work-avoidance/index.md) - Conceptual pattern
- [Release-Please Extra-Files](../../../../build/release-pipelines/release-please/extra-files.md) - Version annotation format
