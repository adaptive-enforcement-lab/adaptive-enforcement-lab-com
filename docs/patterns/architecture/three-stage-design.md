...
- Each job should be [idempotent](../efficiency/idempotency/index.md)
...
See [File Distribution](../../patterns/github-actions/use-cases/file-distribution/index.md) for a complete implementation example.
