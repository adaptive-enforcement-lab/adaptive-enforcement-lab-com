...
description: >-
  Phased rollout plan for SDLC hardening. Foundation to runtime enforcement
  in 90 days. Prioritized by risk and audit importance.
---
...
- Create GitHub App for automation (see [Setup Guide](../../../operator-manual/github-actions/github-app-setup/index.md))
...
See [Commit Signing](../commit-signing.md) for setup guide.
...
See [SBOM Generation](../sbom-generation.md) for full implementation.
